...
export const en: Messages = {
  ...
  'earoForm.save': 'Save to the phone',
  'earoForm.saved': 'Saved. Look for it in the folder you picked.',
  'earoForm.file': 'File it with my documents',
  'earoForm.filed':
    'Filed with your paperwork. When it comes back signed, add that copy there too: a signed EARO is good for later coordination requests.',
  ...
  'docs.save': 'Save to the phone',
  'docs.share': 'Share',
  'docs.saveError': 'The file could not be saved.',
